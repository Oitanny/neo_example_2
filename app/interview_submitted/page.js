...
export default function InterviewEnd() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen py-6 px-8">
      ...
      <h1 className='text-center font-bold text-2xl mb-8'>Interview Ended</h1>
      <div className="bg-[#E0FBFC] shadow-md rounded-md w-56 h-56 items-center justify-center flex mb-10">
        <Image
          src="/ended.png"
          alt="Begin Interview"
          width={200}
      ...
      <p className='text-center mb-8'>Congratulations on successfully submitting the interview. You will be contacted via mail/text for your results</p>
        <button
          onClick={handleNext}
          className="bg-[#424242] text-white px-6 py-2 rounded-md text-center m-2"
        >
          Leave a Feedback
        </button>
